...
// Improvements for this api: Url (an HTTP Verbs) should be moved to constants 
// or we should generate an apiclient which can be directly consumed by these methods and autogenerated by backend
